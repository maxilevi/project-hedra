...
namespace Hedra.Mission.Blocks
{
    public class ReuniteEntitiesMission : MissionBlock
    {
        ...
        public override string ShortDescription => Translations.Get("quest_reunite_entities_short", _entities.Length, _entities[0].Name.ToUpperInvariant());
        ...
        public override string Description
        {
            get
            {
                if (!IsNearAllEntities)
                    return Translations.Get("quest_reunite_entities_find_description", _entities.Length, _entities[0].Name.ToUpperInvariant());
        ...
        private IEntity[] EntitiesNotInTarget => _entities.Where(E => (E.Position - _position).LengthSquared() > NearDistance * NearDistance).ToArray();
