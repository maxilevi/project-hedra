...
from Hedra.Mission import MissionBuilder, QuestTier, QuestReward, DialogObject, ItemCollect
...
def setup_timeline(position, giver, owner, rng):
    ...
    reward.Gold += Trader.SingleItemPrice(
        ItemPool.Grab(item_to_collect.Name)) * Trader.BuyMultiplier * item_to_collect.Amount
