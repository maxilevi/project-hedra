...
namespace Hedra.Engine.QuestSystem
{
    ...
    public class Graveyard : BaseStructure, IUpdatable
	{
		...
		public void Update()
		{
            ...
            if (!Restored &&  (this.Position - Scenes.SceneManager.Game.LPlayer.Position).Xz.LengthSquared 
			   < Radius * Radius)
            {
				...
				if(_passedTime % 2 == 0){
					...
					_particles.Position = Scenes.SceneManager.Game.LPlayer.Position + Vector3.UnitY * 1f;
