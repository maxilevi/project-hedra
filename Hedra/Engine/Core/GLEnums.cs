...
using GLFramebufferTarget = OpenToolkit.Graphics.EXT.FramebufferTarget;
...
namespace Hedra.Engine.Core
{
    ...
    {
        MaxGeometryInputComponents = GLGetPName.MaxGeometryInputComponents,
        MaxGeometryOutputVertices = 0x8DE0,
        MaxGeometryOutputComponents = GLGetPName.MaxGeometryOutputComponents,
        MaxGeometryTotalOutputComponents = 0x8DE1,//GLGetPName.MaxGeometryTotalOutputComponents,
    }
    ...
    {
        Extensions = GLStringName.Extensions
    }
