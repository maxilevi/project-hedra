...
namespace Hedra.Engine.CacheSystem
{
    class PineTreesCache : CacheType
    {
        ...
        {
            this.AddModel(AssetManager.PLYLoader("Assets/Env/Trees/Pine0.ply", Vector3.One));
            this.AddModel(AssetManager.PLYLoader("Assets/Env/Trees/Pine1.ply", Vector3.One));
            this.AddModel(AssetManager.PLYLoader("Assets/Env/Trees/Pine2.ply", Vector3.One));
            this.AddModel(AssetManager.PLYLoader("Assets/Env/Trees/Pine3.ply", Vector3.One));
