...
namespace Hedra.Engine.Rendering
{
    ...
    public class ObjectMeshBuffer : IMeshBuffer
    {
        ...
        public ObjectMeshBuffer(VertexData ModelData)
        {
            ...
            {
                Vertices = new VBO<Vector3>(ModelData.Vertices.ToArray(), ModelData.Vertices.Count * HedraSize.Vector3,
                    VertexAttribPointerType.Float);
                Colors = new VBO<Vector4>(ModelData.Colors.ToArray(), ModelData.Colors.Count * HedraSize.Vector4,
                    VertexAttribPointerType.Float);
                Normals = new VBO<Vector3>(ModelData.Normals.ToArray(), ModelData.Normals.Count * HedraSize.Vector3,
                    VertexAttribPointerType.Float);
                Indices = new VBO<uint>(ModelData.Indices.ToArray(), ModelData.Indices.Count * sizeof(uint),
            ...
            get
            {
                ...
                if (UseLegacyRotation)
                    ...
                    _localRotationMatrix =
                        Matrix4x4.CreateFromQuaternion(QuaternionMath.FromEuler(_localRotation * Mathf.Radian));
        ...
        public Vector3 Rotation
        {
            ...
            set
            {
                ...
                if (UseLegacyRotation)
                    ...
                    _rotationMatrix =
                        Matrix4x4.CreateFromQuaternion(QuaternionMath.FromEuler(_rotation * Mathf.Radian));
            }
        }
        ...
        private void UpdateUniforms()
        {
            UBO.Update(new ObjectMeshBufferData
            {
                ...
                DitherFogTextureShadows = new Vector4(Dither ? 1 : 0, ApplyFog ? 1 : 0, UseNoiseTexture ? 1 : 0,
                    GameSettings.Shadows ? 1 : 0)
            });
            Shader["Outline"] = Outline ? 1 : 0;
            Shader["OutlineColor"] = OutlineColor;
    ...
    {
        [FieldOffset(0)] public Matrix4x4 RotationMatrix;
        [FieldOffset(64)] public Matrix4x4 LocalRotationMatrix;
        [FieldOffset(128)] public Matrix4x4 TransformationMatrix;
        [FieldOffset(192)] public float Alpha;
        [FieldOffset(208)] public Vector3 Scale;
        [FieldOffset(224)] public Vector3 Position;
        [FieldOffset(240)] public Vector3 RotationPoint;
        [FieldOffset(256)] public Vector3 LocalRotationPoint;
        [FieldOffset(272)] public Vector3 BeforeRotation;
        [FieldOffset(288)] public Vector4 Tint;
        [FieldOffset(304)] public Vector4 BaseTint;
        [FieldOffset(320)] public Vector3 PlayerPosition;
        [FieldOffset(332)] public int IgnoreSSAO;
        [FieldOffset(336)] public Vector4 DitherFogTextureShadows;

        public override bool Equals(object obj)
        {
            if (obj is ObjectMeshBufferData other)
                return Alpha.Equals(other.Alpha) && Scale.Equals(other.Scale) && Position.Equals(other.Position) &&
                       LocalRotationMatrix.Equals(other.LocalRotationMatrix) &&
                       TransformationMatrix.Equals(other.TransformationMatrix) &&
                       RotationPoint.Equals(other.RotationPoint) && RotationMatrix.Equals(other.RotationMatrix) &&
                       LocalRotationPoint.Equals(other.LocalRotationPoint) &&
                       BeforeRotation.Equals(other.BeforeRotation) && Tint.Equals(other.Tint) &&
                       BaseTint.Equals(other.BaseTint) &&
                       PlayerPosition.Equals(other.PlayerPosition) && IgnoreSSAO.Equals(other.IgnoreSSAO) &&
                       DitherFogTextureShadows.Equals(other.DitherFogTextureShadows);
            return false;
        }
    }
}