...
namespace Hedra.Engine.Rendering.Core
{
    public static class VBOCache
    {
        ...
        public static bool Exists<T>(T[] Data, int SizeInBytes, VertexAttribPointerType PointerType,
            BufferTarget BufferTarget, BufferUsageHint Hint, out uint Id)
        {
            Id = 0;
        ...
        public static void Create<T>(T[] Data, int SizeInBytes, VertexAttribPointerType PointerType,
            BufferTarget BufferTarget, BufferUsageHint Hint, out uint Id) where T : unmanaged
        {
            var hash = Hash(Data, SizeInBytes, PointerType, BufferTarget, Hint);
        ...
        private static void DoCreate<T>(T[] Data, int SizeInBytes, VertexAttribPointerType PointerType,
            BufferTarget BufferTarget, BufferUsageHint Hint, out uint Id) where T : unmanaged
        {
        ...
        public static void Update<T>(T[] Data, int SizeInBytes, VertexAttribPointerType PointerType,
            BufferTarget BufferTarget, BufferUsageHint Hint, ref uint Id) where T : unmanaged
        {
            var originalId = Id;
        ...
        private static void DoUpdate<T>(T[] Data, int SizeInBytes, BufferTarget Target, BufferUsageHint Hint, uint Id)
            where T : unmanaged
        {
        ...
        private static string Hash<T>(T[] Data, int SizeInBytes, VertexAttribPointerType PointerType,
            BufferTarget BufferTarget, BufferUsageHint Hint)
        {
