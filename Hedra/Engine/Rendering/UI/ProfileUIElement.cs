    ...
    public class ProfileUIElement : Panel
    {
        ...
        public ProfileUIElement(IPlayer Player, Vector2 Position, float Scale)
        {
            ...
            _healthBackground = new BackgroundTexture(
                Graphics2D.LoadFromAssets("Assets/UI/HealthBarBackground.png"), Vector2.Zero,
                Graphics2D.SizeFromAssets("Assets/UI/HealthBarBackground.png").As1920x1080() * Scale
            );
            _manaBackground = new BackgroundTexture(
                Graphics2D.LoadFromAssets("Assets/UI/ManaBarBackground.png"), Vector2.Zero,
                Graphics2D.SizeFromAssets("Assets/UI/ManaBarBackground.png").As1920x1080() * Scale
            );
            _xpBackground = new BackgroundTexture(
                Graphics2D.LoadFromAssets("Assets/UI/XpBarBackground.png"), Vector2.Zero,
                Graphics2D.SizeFromAssets("Assets/UI/XpBarBackground.png").As1920x1080() * Scale
            );
            ...
            _manaBar = new TexturedBar(Graphics2D.LoadFromAssets("Assets/UI/ManaBar.png"), Vector2.Zero,
                Graphics2D.SizeFromAssets("Assets/UI/ManaBar.png").As1920x1080() * Scale,
                () => Player.Mana,
                () => Player.MaxMana);

            _xpBar = new TexturedBar(Graphics2D.LoadFromAssets("Assets/UI/XpBar.png"), Vector2.Zero,
                Graphics2D.SizeFromAssets("Assets/UI/XpBar.png").As1920x1080() * Scale,
                () => XP,
                () => MaxXP);
        ...
        public void Update()
        {
            ...
            _healthBackground.Position = new Vector2(position.X + _healthBackground.Scale.X * 2f * _scale,
                position.Y + _healthOffset.Y * _scale);
            _manaBackground.Position = new Vector2(position.X + _manaBackground.Scale.X * 2f * _scale,
                position.Y + _manaOffset.Y * _scale);
            _xpBackground.Position = new Vector2(position.X + _xpBackground.Scale.X * 2f * _scale,
                position.Y + _xpOffset.Y * _scale);
            _healthBar.Position =
                new Vector2(position.X + _healthBar.Scale.X * 2f * _scale, _healthBackground.Position.Y);
