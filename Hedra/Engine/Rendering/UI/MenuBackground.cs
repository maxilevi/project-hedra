    ...
    public static class MenuBackground
    {
        ...
        public static Vector3 NewLocation
        {
            get
            {
                ...
                return new Vector3(Position.X, Physics.HeightAtPosition(Position.X, Position.Z) + Position.Y,
                    Position.Z);
            }
        }
        ...
        private static IEnumerator MakePlatform()
        {
            ...
            {
                var NewChunk = World.GetChunkAt(CreatorPosition);
                if (NewChunk != null)
            ...
            PlatformPosition = CreatorPosition.Xz().ToVector3() + Vector3.UnitX * 4 +
                               Vector3.UnitY * Physics.HeightAtPosition(PlatformPosition + Vector3.UnitX * 4);
        }
