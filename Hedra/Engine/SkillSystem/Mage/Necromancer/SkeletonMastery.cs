...
{
    public class SkeletonMastery : PassiveSkill, IMinionMastery
    {
        ...
        private float ActualHealth =>
            Humanoid.CalculateMaxHealth(ClassDesign.FromString(Class.Warrior), SkeletonLevel, 1) + HealthBonus;
        ...
        public override string[] Attributes => new[]
        {
            ...
            Translations.Get("skeleton_mastery_health_change",
                ActualHealth.ToString("0.0", CultureInfo.InvariantCulture)),
