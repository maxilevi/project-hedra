...
namespace Hedra.Engine.SkillSystem.Mage.Druid
{
    public class Werewolf : MorphSkill
    {
        ...
        {
            User.AddComponent(_attackSpeed =
                new AttackSpeedBonusComponent(User, User.AttackSpeed * AttackSpeedMultiplier));
            User.AddComponent(_attackPower =
                new AttackPowerBonusComponent(User, User.AttackPower * AttackPowerMultiplier));
