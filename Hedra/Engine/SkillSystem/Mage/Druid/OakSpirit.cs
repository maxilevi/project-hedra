...
namespace Hedra.Engine.SkillSystem.Mage.Druid
{
    public class OakSpirit : MorphSkill
    {
        ...
        {
            User.AddComponent(_attackResistance =
                new AttackResistanceBonusComponent(User, User.AttackResistance * ResistanceBonus));
        ...
        protected override void ApplyVisuals(AnimatedModel Model, string ModelPath)
        {
            ...
            AnimatedUpdatableModel.Paint(Model, ModelPath, woodColor,
                region.Colors.LeavesColors[Utils.Rng.Next(0, region.Colors.LeavesColors.Length)], woodColor * .65f);
        }
    }
}