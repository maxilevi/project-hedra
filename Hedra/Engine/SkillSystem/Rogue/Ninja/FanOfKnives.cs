...
namespace Hedra.Engine.SkillSystem.Rogue.Ninja
{
    ...
    {
        private static readonly VertexData KnifeModel =
            AssetManager.PLYLoader("Assets/Items/Ammo/Kunai.ply", Vector3.One);

        public FanOfKnives()
        {
            SkillAnimation.RegisterOnProgressEvent(.25f, Animation => { ThrowAll(); });
        }
        ...
        protected override Animation SkillAnimation { get; } =
            AnimationLoader.LoadAnimation("Assets/Chr/RogueKnifeThrow.dae");
