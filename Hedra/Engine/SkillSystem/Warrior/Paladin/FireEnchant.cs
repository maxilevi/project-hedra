        ...
        public override void Update()
        {
            ...
            if (IsActive)
            {
                ...
                World.Particles.Position =
                    User.LeftWeapon.MainMesh.TransformPoint(Vector3.UnitY *
                                                            (User.LeftWeapon.MainMesh.CullingBox?.Size.Y * .25f ?? 0));
                ...
                World.Particles.PositionErrorMargin =
                    Vector3.One * (User.LeftWeapon.MainMesh.CullingBox?.Size.Y * .25f ?? 0);
