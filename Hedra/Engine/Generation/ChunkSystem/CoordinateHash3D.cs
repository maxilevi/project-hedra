...
namespace Hedra.Engine.Generation.ChunkSystem
{
    ...
    public struct CoordinateHash3D : IEquatable<CoordinateHash3D>
    {
        ...
        public CoordinateHash3D(Vector3 Coordinates) : this((byte)Coordinates.X, (byte)Coordinates.Y,
            (byte)Coordinates.Z)
        {
        }
        ...
        {
#if DEBUG
            if (MaxCoordinateSizeXZ != (int)(Chunk.Width / Chunk.BlockSize) ||
                MaxCoordinateSizeY != (int)(Chunk.Height / Chunk.BlockSize))
