...
{
    internal class FernDesign : PlantDesign
    {
        public override VertexData Model => CacheManager.GetModel(CacheItem.Fern);
        ...
        public override VertexData Paint(Vector3 Position, VertexData Data, Random Rng)
        {
            ...
            var underchunk = World.GetChunkAt(Position);
            Data.ReColor(underchunk.Biome.Colors.GrassColor * .7f);
