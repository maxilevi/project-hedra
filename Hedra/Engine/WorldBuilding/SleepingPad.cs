...
namespace Hedra.Engine.WorldBuilding
{
    public class SleepingPad : InteractableStructure
    {
        ...
        protected override void OnKeyDown(object Sender, KeyEventArgs Args)
        {
            ...
            if (Args.Key == Controls.Descend && IsOccupied && Sleeper == GameManager.Player) SetSleeper(null);
        }
        ...
        public void SetSleeper(IHumanoid Human)
        {
            if (Sleeper != null)
            {
                ...
                if (dmgComponent != null) dmgComponent.OnDamageEvent -= OnDamageWakeUp;
            ...
            if (Human != null)
            {
                ...
                if (dmgComponent != null)
                {
                    ...
                    dmgComponent.OnDamageEvent += OnDamageWakeUp;
                }
