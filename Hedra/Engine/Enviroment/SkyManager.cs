...
namespace Hedra.Engine.Enviroment
{
	...
	public static class SkyManager
	{
		...
		public static void Update()
		{
			...
			if(Snowing && IsRaining && !SceneManager.Game.InMenu && SceneManager.Game.LPlayer != null){
				Rain.Position = SceneManager.Game.LPlayer.Position + Vector3.UnitY * 160;
			...
			if(IsRaining && Time.timeScale == 1 && SceneManager.Game.LPlayer != null && underChunk != null)
            {
				if(!Snowing){
					Rain.Position = SceneManager.Game.LPlayer.Position + Vector3.UnitY * 256;
