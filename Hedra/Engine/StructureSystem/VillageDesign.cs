...
namespace Hedra.Engine.StructureSystem
{
    internal class VillageDesign : StructureDesign
    {
        ...
        public override void Build(Vector3 Position, CollidableStructure Structure)
        {
            ...
            World.QuestManager.SpawnVillager(Position + farmTransMatrix.ExtractTranslation() + Vector3.UnitX * 360.0f, true);
            World.QuestManager.SpawnVillager(Position + farmTransMatrix.ExtractTranslation() + Vector3.UnitX * 220.0f + Vector3.UnitZ * 180f, true);
            World.QuestManager.SpawnVillager(Position + farmTransMatrix.ExtractTranslation() + Vector3.UnitX * 220.0f + Vector3.UnitZ * 400f, true);
