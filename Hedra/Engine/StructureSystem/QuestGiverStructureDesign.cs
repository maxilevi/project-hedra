...
{
    public abstract class QuestGiverStructureDesign<T> : SimpleStructureDesign<T>
        where T : BaseStructure, IQuestStructure
    {
                ...
                DoWhenChunkReady(position, P =>
                {
                    ...
                    npc.Rotation =
                        Physics.DirectionToEuler(
                            npc.Orientation = -Vector3.Transform(DefaultLookingDirection, Rotation));
                    npc.Position = pos;
