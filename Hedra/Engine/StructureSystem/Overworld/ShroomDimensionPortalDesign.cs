...
{
    public class ShroomDimensionPortalDesign : SimpleFindableStructureDesign<ShroomDimensionPortal>, ICompletableStructureDesign
    {
        ...
        {
            return new ShroomDimensionPortal(Position + Vector3.UnitY * 8f, StructureScale * 10f, RealmHandler.GhostTown, SpawnGhostTownPortalDesign.Position);
        }
