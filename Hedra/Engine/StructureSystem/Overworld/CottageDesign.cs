...
{
    public abstract class CottageDesign<T> : QuestGiverStructureDesign<T>, IFindableStructureDesign
        where T : Cottage, IQuestStructure
    {
        ...
        protected static void AddOutputToStructure(CollidableStructure Structure, BuildingOutput Output,
            Vector3 Position)
        {
            ...
            for (var i = 0; i < structures.Length; ++i) structures[i].Position += Position.Y * Vector3.UnitY;
