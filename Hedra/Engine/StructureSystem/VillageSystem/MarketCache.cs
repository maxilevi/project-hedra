...
namespace Hedra.Engine.StructureSystem.VillageSystem
{
    public class MarketCache
    {
        ...
        public MarketCache()
        {
            ...
            ShelfModels_Clones.Add(2, AssetManager.PLYLoader("Assets/Env/Village/MarketStand2.ply", Vector3.One).AsCompressed());
            ShelfModels_Clones.Add(3, AssetManager.PLYLoader("Assets/Env/Village/MarketStand3.ply", Vector3.One).AsCompressed());
            ShelfModels_Clones.Add(4, AssetManager.PLYLoader("Assets/Env/Village/MarketStand4.ply", Vector3.One).AsCompressed());
            ShelfModels_Clones.Add(5, AssetManager.PLYLoader("Assets/Env/Village/MarketStand5.ply", Vector3.One).AsCompressed());
            ShelfModels_Clones.Add(6, AssetManager.PLYLoader("Assets/Env/Village/MarketStand6.ply", Vector3.One).AsCompressed());
        }
    }
}
