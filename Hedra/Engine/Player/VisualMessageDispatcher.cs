...
namespace Hedra.Engine.Player
{
    public class VisualMessageDispatcher : IMessageDispatcher
    {
        ...
        public VisualMessageDispatcher(LocalPlayer Player)
        {
            ...
            _playerText = new GUIText(string.Empty, new Vector2(0, 0), Color.White, FontCache.Get(UserInterface.Fonts.Families[0], 12));

            _notificationText = new GUIText(string.Empty, new Vector2(0.7f, -0.9f), Color.FromArgb(255, 39, 39, 39), FontCache.Get(UserInterface.Fonts.Families[0], 12));
