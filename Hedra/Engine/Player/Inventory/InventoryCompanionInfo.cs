...
namespace Hedra.Engine.Player.Inventory
{
    public sealed class InventoryCompanionInfo : InventoryInterfaceItemInfo, IDisposable
    {
        ...
        protected override void AddLayout()
        {
            ...
            HintTexture.Position = BackgroundTexture.Position -
                                   (HintTexture.Scale.Y * 1.5f + BackgroundTexture.Scale.Y) * Vector2.UnitY;
        ...
        {
            Script.Execute("update_ui", Item, Companion, TopLeftText, TopRightText, BottomLeftText, BottomRightText,
                Level, ItemText);
        }
