...
namespace Hedra.Engine.BiomeSystem.Savanna
{
    public class SavannaBiomeGenerationDesign : BiomeGenerationDesign
    {
        ...
        protected override void DoBuildDensityMap(FastNoiseSIMD Noise, float[][][] DensityMap, BlockType[][][] TypeMap, int Width, int Height,
            float HorizontalScale, float VerticalScale, Vector3 Offset)
        {
            throw new System.NotImplementedException();
        }

        protected override void DoBuildHeightMap(FastNoiseSIMD Noise, float[][] HeightMap, BlockType[][] TypeMap, int Width, float Scale,
            Vector2 Offset)
        {
            throw new System.NotImplementedException();
        }
